...
/**
 * Servlet to to handle the json object that is sent to the front-end app to
 * give it the random generated answers.
 *
...
public class IOServlet extends HttpServlet {
    ...
    /**
     * Object to communicate with the controller layer.
     */
